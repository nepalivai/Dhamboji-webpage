...
function Nav() {
  return (
    <div className=" flex justify-center">
      <nav className="w-full bg-opacity-20 md:w-auto bg-black fixed z-10 backdrop-blur-[15px] shadow-xl pl-10 pr-10 flex gap-10 items-center rounded-2xl">
        ...
        <ul className=" z-10 items-center text-lg gap-[20px] flex">
          <a href="/">
